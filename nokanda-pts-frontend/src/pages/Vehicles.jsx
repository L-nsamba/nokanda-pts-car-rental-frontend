        ...
        <>
            ...
            {editingVehicle && (
                <Modal
                    ...
                    title="Edit Vehicle"
                    subtitle={editingVehicle.vehicle_type}
            ...
            {showCreateModal && (
                <Modal
                    ...
                    title="Add Vehicle"
                    subtitle="New vehicles start out Available"
                    onConfirm={handleCreateSave}
                    confirmDisabled={creating || !createForm.photo_url || !createForm.description}
                    confirmLabel={creating ? 'Adding...' : 'Add Vehicle'}
                >
                    <div>
                        <label className="text-xs text-gray-500 uppercase tracking-wide block mb-1">
                        Vehicle Type
